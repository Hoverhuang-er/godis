...
LDFLAGS="-s -w -X github.com/hdt3213/godis/internal/database.godisVersion=${VERSION}"
...
for target in "${TARGETS[@]}"; do
    ...
    go build -tags greenteagc -ldflags="${LDFLAGS}" -o "${BUILD_DIR}/${output_name}" ./cmd/godis/
